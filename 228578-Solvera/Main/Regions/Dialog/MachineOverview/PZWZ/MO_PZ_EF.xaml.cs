...
namespace HMI.DialogRegion.MO.Views
{
    ...
    public partial class MO_PZ_EF
    {
        ...
        private void View_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            VStatus = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Exhaust fan.State.Ventilator");
            VStatus.Change += VStatus_Change;

            VPurge = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Exhaust fan.State.isPurging");
            VPurge.Change += VPurge_Change;

            VPS1 = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Exhaust fan.State.Pressure switch 1");
            VPS1.Change += VPS1_Change;

            VPS2 = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.02 PZ.01 Air.DB PZ Air HMI.Actual.Exhaust fan.State.Pressure switch 2");
