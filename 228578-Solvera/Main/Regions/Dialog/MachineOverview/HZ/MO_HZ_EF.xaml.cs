...
namespace HMI.DialogRegion.MO.Views
{
    ...
    public partial class MO_HZ_EF
    {
        ...
        private void View_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            //VStatus = VS.GetVariable("CPU2.PLC.Blocks.05 Airflow Heating.01 PZ.DB PZ Air HMI.Actual.Exhaust air.State.Ventilator");
            //VStatus.Change += VStatus_Change;

            //VPurge = VS.GetVariable("CPU2.PLC.Blocks.05 Airflow Heating.01 PZ.DB PZ Air HMI.Actual.Exhaust air.State.Purge time acitive");
            //VPurge.Change += VPurge_Change;

            VPS1 = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.05 HZ 1.01 Air.DB HZ 1 Air HMI.Actual.Circulation fan.State.Pressure switch 1");
            VPS1.Change += VPS1_Change;

            VPS2 = VS.GetVariable("CPU2.PLC.Blocks.04 Tray handling.05 HZ 1.01 Air.DB HZ 1 Air HMI.Actual.Circulation fan.State.Pressure switch 2");
