...
namespace HMI.DialogRegion.MO.Views
{
    ...
    [ExportView("MO_Coating_EF")]
    public partial class MO_Coating_EF
    {
        public MO_Coating_EF()
        {
            InitializeComponent();
        }
        ...
        private void View_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            VStatus = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.01 CD.07 Air.DB CD Air HMI.Actual.Exhaust fan.Ventilator");
            VStatus.Change += VStatus_Change;

            VPurge = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.01 CD.07 Air.DB CD Air HMI.Actual.Exhaust fan.isPurging");
            VPurge.Change += VPurge_Change;

            VPS1 = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.01 CD.07 Air.DB CD Air HMI.Actual.Exhaust fan.Pressure switch 1");
            VPS1.Change += VPS1_Change;

            VPS2 = VS.GetVariable("CPU1.PLC.Blocks.03 Basket coating.01 CD.07 Air.DB CD Air HMI.Actual.Exhaust fan.Pressure switch 2");
