...
namespace HMI.Resources.UserControls
{
    public partial class CoatingStep2 : UserControl
    {
        public CoatingStep2()
        {
            ...
            InitializeComponent();
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Type", 2);
        }
        ...
        private void Astraight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Straight time", 0);
        ...
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Angle", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Reverse", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Draining", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Planet", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.Straight time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Dipping.DT", 0);
        }
        private void ResetSpinning()
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Spinning.1.Rotor", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Spinning.1.Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Spinning.2.Planet", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Spinning.2.Rotor", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Spinning.2.Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Spinning.3.Rotor", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[1].Spinning.3.Time", 0);
        }
        #endregion
