...
namespace HMI.Resources.UserControls
{
    public partial class CoatingStep3 : UserControl
    {
        public CoatingStep3()
        {
            ...
            InitializeComponent();
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Type", 0);
        }
        ...
        private void Astraight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Straight time", 0);
        ...
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Angle", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Reverse", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Draining", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Planet", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Straight", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.Straight time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Dipping.DT", 0);
        }
        private void ResetSpinning()
        {
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Spinning.1.Rotor", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Spinning.1.Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Spinning.2.Planet", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Spinning.2.Rotor", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Spinning.2.Time", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Spinning.3.Rotor", 0);
            Class.SetValue("CPU1.PLC.Blocks.03 Basket coating.01 CD.00 Main.DB CD HMI.PC.Station.Step[2].Spinning.3.Time", 0);
        }
        #endregion
